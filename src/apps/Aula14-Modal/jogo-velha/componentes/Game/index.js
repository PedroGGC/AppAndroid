...
export default function Game() {
  ...
  function handleEscolheCasa(casa) {
    ...
    const tabuleiroAtualizado = defineCasaEscolhida(casa);
    defineJogadorAtual();

    const resultado = verificaResultado(tabuleiroAtualizado);
      ...
      <View style={styles.tabuleiro}>
        <View style={styles.linha}>
          <Pressable onPress={() => handleEscolheCasa(0)}>
            <Casa jogador={posicaoJogo[0]} temBordaDireita={true} temBordaInferior={true} pecaVitoriosa={posicaoVitoria[0]} />
          </Pressable>
          <Pressable onPress={() => handleEscolheCasa(1)}>
            <Casa jogador={posicaoJogo[1]} temBordaDireita={true} temBordaInferior={true} pecaVitoriosa={posicaoVitoria[1]} />
          </Pressable>
          <Pressable onPress={() => handleEscolheCasa(2)}>
            <Casa jogador={posicaoJogo[2]} temBordaInferior={true} pecaVitoriosa={posicaoVitoria[2]} />
          </Pressable>
        </View>
        <View style={styles.linha}>
          <Pressable onPress={() => handleEscolheCasa(3)}>
            <Casa jogador={posicaoJogo[3]} temBordaDireita={true} temBordaInferior={true} pecaVitoriosa={posicaoVitoria[3]} />
          </Pressable>
          <Pressable onPress={() => handleEscolheCasa(4)}>
            <Casa jogador={posicaoJogo[4]} temBordaDireita={true} temBordaInferior={true} pecaVitoriosa={posicaoVitoria[4]} />
          </Pressable>
          <Pressable onPress={() => handleEscolheCasa(5)}>
            <Casa jogador={posicaoJogo[5]} temBordaInferior={true} pecaVitoriosa={posicaoVitoria[5]} />
          </Pressable>
        </View>
        <View style={styles.linha}>
          <Pressable onPress={() => handleEscolheCasa(6)}>
            <Casa jogador={posicaoJogo[6]} temBordaDireita={true} pecaVitoriosa={posicaoVitoria[6]} />
          </Pressable>
          <Pressable onPress={() => handleEscolheCasa(7)}>
            <Casa jogador={posicaoJogo[7]} temBordaDireita={true} pecaVitoriosa={posicaoVitoria[7]} />
          </Pressable>
          <Pressable onPress={() => handleEscolheCasa(8)}>
            <Casa jogador={posicaoJogo[8]} pecaVitoriosa={posicaoVitoria[8]} />
          </Pressable>
        </View>
      </View>
    </View>
