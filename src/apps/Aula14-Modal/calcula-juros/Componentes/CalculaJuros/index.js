  ...
  return (
    <View style={estilosGlobal.container}>
      ...
      <View style={estilosGlobal.areaInput}>
        ...
        <TextInput 
          style={estilosGlobal.input} 
          placeholder="Digite o valor em reais" 
          onChangeText={(valorDigitado) => setValor(valorDigitado)} 
      ...
      <View style={estilosGlobal.areaInput}>
        ...
        <TextInput 
          style={estilosGlobal.input} 
          placeholder="Digite o percentual de juros" 
          onChangeText={(jurosDigitado) => setJuros(jurosDigitado)} 
          keyboardType="numeric"
        />
      </View>
      ...
      <View style={estilosGlobal.areaResultado}>
        ...
        <Text style={estilosGlobal.tituloResultado}>Valor total a pagar:</Text>
