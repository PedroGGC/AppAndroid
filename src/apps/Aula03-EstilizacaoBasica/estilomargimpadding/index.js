  ...
  return (
    <ScrollView contentContainerStyle={estilos.container}>
      ...
      <View style={estilos.card}>
        ...
        <Image style={estilos.img} source={require('../../../../assets/Aula03-EstilizacaoBasica/mobile-img.png')} />
      </View>

      <View style={estilos.card}>
        <Text style={estilos.titulo}>Backend Developer</Text>
        <Text style={estilos.texto}>Elijah Price / Mr Glass</Text>
        <Image style={estilos.img} source={require('../../../../assets/Aula03-EstilizacaoBasica/backend-img.png')} />
      </View>

      <View style={estilos.card}>
        <Text style={estilos.titulo}>Full Stack Developer</Text>
        <Text style={estilos.texto}>Chuck Norris</Text>
        <Image style={estilos.img} source={require('../../../../assets/Aula03-EstilizacaoBasica/fullstack-img.png')} />
      </View>
